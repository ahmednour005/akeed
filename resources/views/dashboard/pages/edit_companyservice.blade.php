                ...
                <form class="needs-validation " novalidate action="{{route('companyservice.update',$companyservice->id)}}" method="post"  enctype="multipart/form-data">
                    ...
                    <div class="form-row ">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" class="form-control" name="en_name" value="{{ $companyservice->en_name}}" placeholder="English name"  >
                        </div>

                        <div class="col-md-12 mb-3">
                            <label for="validationCustom02">Arabic Details</label>
                            <textarea type="text" class="form-control" name="ar_details" maxlength="65" placeholder="Arabic Details"  required>{{ $companyservice->en_details}}</textarea>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea type="text" class="form-control" name="en_details" maxlength="65"  placeholder="English Details"  >{{ $companyservice->en_details}}</textarea>
                            maximum length of 65 characters
                        </div>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" name="icon" value="{{ $companyservice->icon}}" class="icon-picker readonly-icon"  required/>
                            <div class="valid-feedback">
                                Looks good!
                            </div>
                        </div>
