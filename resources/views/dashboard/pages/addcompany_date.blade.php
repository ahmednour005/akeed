        ...
        <div class="row">
            ...
            <div class="col-6 ">
                <div class="page-links-heading">
                  Add Company Date / <a href="{{ route('company_date.index') }}">Company Dates</a> /
 ...
 <div class="app-main__inner">
          ...
          <div class="main-card mb-3 card ">
            <div class="card-body">
                ...
                <form class="needs-validation " novalidate action="{{route('company_date.store')}}" method="post"  enctype="multipart/form-data">
                    @csrf
                    <div class="form-row ">

                        <div class="col-md-12 mb-3">
                            <label for="validationCustom02">Company Date</label>
                            <input type="date" class="form-control" name="company_date" placeholder="English name"  required>
                        </div>
                        <div class="col-md-12 mb-3">
                            <label for="validationCustom02">Arabic Title</label>
                            <input type="text" class="form-control" name="ar_title"  placeholder="Arabic name"  required>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" class="form-control" name="en_title" placeholder="English name"  >
                        </div>
